...
const FormulairePayer = () => {
    const formulaireContext = useContext(FormulaireContext);

    const {openDialogue,clearFormulaire,filtered,closeDialogue,open,getFormulairePayer,formulaires} = formulaireContext;
...
export default FormulairePayer;
