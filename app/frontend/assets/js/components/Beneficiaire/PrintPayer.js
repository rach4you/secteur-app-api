...
const PrintPayer = ({formulaire,nombre}) => {
        ...
        <div id="print-area">
            <div className="viewer__billing-info px-4 py-5 flex justify-between">
                ...
                <div className="text-right">
                    <h5 className="font-normal mb-4 capitalize"><strong>Annexe 3.4</strong> </h5>
                </div>
            </div>
            ...
            <div className="viewer__billing-info  py-2 flex justify-between">
                ...
                <div>
                    <h5 className="font-normal mb-4 capitalize text-center"><strong>ETAT DES BENEFICIAIRES DE LA FORMATION</strong> </h5>
                </div>
                <div >
